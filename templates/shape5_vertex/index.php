  ...
  <!-- Header -->      
    ...
    <div id="s5_header_area_inner2">  
      <div id="s5_header_wrap">
        ...
        <?php } else { ?>
          <img alt="logo"  style="height:<?php echo $s5_logo_height ?>px;width:<?php echo $s5_logo_width ?>px" src="<?php echo $s5_directory_path ?>/images/logo.png" id="s5_logo" onclick="window.document.location.href='<?php echo $LiveSiteUrl ?>'"></img>
        <?php } ?>
